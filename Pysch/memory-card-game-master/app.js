...
let timer;
//Have to create a variable that checks how many flips a user has performed
let flips=0;
...
function victory() {
  ...
  finished.innerText = `You have won!!!\nThe number of flips taken was ${flips}\nTime taken to complete was ${50-timer} seconds`;
  audioController.stopBgMusic();
}
